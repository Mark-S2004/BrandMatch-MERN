            ...
            <div className="px-8 py-12">
              <div className="relative w-24 h-24 mx-auto">
                <img
                  ...
                  alt=""
                />
                <div className="absolute top-0 right-0 flex items-center justify-center bg-dark-red rounded-full w-7 h-7">
                  <svg
              ...
              <p className="text-base font-semibold text-black mt-9">Alex R</p>
            </div>
          </div>
